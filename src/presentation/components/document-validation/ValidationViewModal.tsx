...
import { DocumentSignaturePanel } from "@/presentation/components/document-submission/DocumentSignaturePanel";
...
interface ValidationViewModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function ValidationViewModal({
  isOpen,
  onClose,
  documentId,
}: ValidationViewModalProps) {
    ...
    return (
      <div className="flex flex-col lg:flex-row gap-4 h-full overflow-hidden">
        ...
        <div className="w-full lg:w-[380px] shrink-0 bg-white rounded-lg border border-[#E1E2E3] flex flex-col order-2 lg:order-1 overflow-hidden">
          ...
          {/* Review Actions - Only Close button */}
