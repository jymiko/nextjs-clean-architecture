...
interface DocumentValidationFiltersProps {
  departments?: Department[];
  documentTypes?: DocumentType[];
  filters?: ValidationFilterState;
  onFilterChange?: (filters: ValidationFilterState) => void;
}
...
export function DocumentValidationFilters({
  departments: _departments = defaultDepartments,
  documentTypes = defaultDocumentTypes,
  filters: externalFilters,
  onFilterChange,
}: DocumentValidationFiltersProps) {
  // _departments reserved for future department filter implementation
  const [internalFilters, setInternalFilters] = useState<ValidationFilterState>({
    department: "",
    documentType: "",
    status: "",
    dateFrom: undefined,
  ...
  const updateFilter = (key: keyof ValidationFilterState, value: string | Date | undefined) => {
