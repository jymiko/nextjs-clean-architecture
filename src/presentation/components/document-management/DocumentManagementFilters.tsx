...
export function DocumentManagementFilters({
  departments = defaultDepartments,
  documentTypes = defaultDocumentTypes,
  filters: externalFilters,
  onFilterChange,
}: DocumentManagementFiltersProps) {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="pending_obsolete_approval">Pending Obsolete Approval</SelectItem>
          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                <Calendar className="h-4 w-4 text-[#384654]" />
              </Button>
            </PopoverTrigger>
